        ...
        <div class="swiper-thumbs-container">
            ...
            <button class="slider__btn-right swiper-button-next">
                <svg width="25" height="24" viewBox="0 0 25 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path d="M8.5 5V19L19.5 12L8.5 5Z" fill="#212121" />
                </svg>
            </button>
            <!-- <img src="<?php bloginfo('template_url'); ?>/assets/images/icons/arrow-next.svg" width="32" height="32" alt="icon"> -->
            <!-- <svg class="" width="32" height="32" xmlns="http://www.w3.org/2000/svg">
                <use xlink:href="<?php bloginfo('template_url'); ?>/assets/images/icons/arrow-next" alt="arrow right"></use>
            </svg> -->
