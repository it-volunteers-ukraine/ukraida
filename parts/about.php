    ...
    <div class="img-text__wrap">
        ...
        <div class="img-text__content">
            ...
            <div class="img-text__button">
                <a href="<?php echo esc_url($rows[0]['img_text_btn_link']); ?>" class="img-text__btn">
                    <?php echo $rows[0]['img-text-btn']; ?>
                </a>
            </div>
        </div>
    </div>
...
if ($rowNumber) : ?>
    <section class="block-icons section block-icons--num">
        ...
        <div class="block-icons__wrap">
            <?php foreach ($rowNumber[0]['block-number_content'] as $content) : ?>
                <div class="block-icons__item">
...
<section class="img-text img-text--reverse section">
    ...
    <div class="img-text__wrap">
        <div class="img-text__content">
            ...
            <div class="img-text__button">
                <a href="<?php echo esc_url($rows[1]['img_text_btn_link']); ?>" class="img-text__btn-advanced">
