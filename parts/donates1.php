...
<div class="donate1 ">
    ...
    <div class="textblock">
        ...
        <?php if (get_field('donates1_btn_name', $currend_id)) : ?>
            <a href="<?php echo get_field('donates1_btn_url', $currend_id); ?>" class="textblock-btn"><?php echo get_field('donates1_btn_name', $currend_id); ?></a>
        <?php endif ?>
    </div>
</div>