<?php
    ...
    $sId = "swiper" . $sin;
    $nbId = "swiper" . $sin . "NextButton";
    $pbId = "swiper" . $sin . "PrevButton";
    $pId = "swiper" . $sin . "Pagination";
?>

<section>
    <div class="slider__wrapper">
        <button class="slider__button swiper-button-prev" id="<?= $pbId ?>">
        ...
        <div class="slider">
            <div class="slider__container">
                <div class="slider__wrap slider-main swiper-main swiper" id="<?= $sId ?>">
                    <div class="slider__track-big swiper-wrapper">
                        <?php
                            $image_urls = get_field('project_images');
        ...
        <button class="slider__button swiper-button-next" id="<?= $nbId ?>">
            <svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
