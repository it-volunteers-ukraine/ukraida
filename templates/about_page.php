    ...
    <section class="slider__wrapper about__slider-wrapper container">
        ...
        <div class="slide">
            <div class="about__title-wrapper-slider">
                <h2 class="about__title"><?php echo get_field('section_articles_title', $currend_id); ?></h2>
            </div>
                                ...
                                <div class="slider__item-container">
                                    <div class="slider__item-content">
                                        <div class="slider__item-flex">
                                            <div class="slider__item-subtitle"><?php echo get_field('section_article-item_subtitle', $currend_id); ?></div>
                                            <div>
                                                <div class="slider__item-title"><?php echo get_field('section_article-item_title', $currend_id); ?></div>
                                                <div class="slider__item-text"><?php echo get_field('section_article_text', $currend_id); ?></div>
                                                <div class="slider__item-link"><a href="">Перейти на статтю</a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
