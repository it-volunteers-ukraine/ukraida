                            ...
                            <div class="swiper-slide slider__item-wrapper">
                                <div class="slider__item-container">
                                    <div>
                                        ...
                                        <?php $image = get_field('photo_journalist', $currend_id);
                                        if( !empty($image) ): ?>
                                        <img  src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>">
                                        <?php endif; ?>
                                    </div>
...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="display:none;">
    <symbol id="left-arrow" width="24" height="24" viewBox="0 0 24 24">
    ...
    <symbol id="right-arrow" width="24" height="24" viewBox="0 0 24 24">
