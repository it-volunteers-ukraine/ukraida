...
function wp_it_volunteers_scripts()
{
  ...
  if (is_page_template('templates/receipts.php')) {
    // Template style
    wp_enqueue_style('receipts-style', get_template_directory_uri() . '/assets/styles/template-styles/receipts.css', array('main'));
  }
